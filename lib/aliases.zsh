...
alias ass="code -w ~/.oh-my-zsh/lib/aliases.zsh; source ~/.oh-my-zsh/lib/aliases.zsh"
alias aliases="echo 'get some ass'"
alias pra="${VISUAL} -w ~/.oh-my-zsh/aliases_private.zsh ;source ~/.oh-my-zsh/aliases_private.zsh"
...
alias hst="sudo ${VISUAL} /etc/hosts"
...
alias sni8="${VISUAL} ${BASH_UTILS_LOCATION}/utils/utf8CharacterList.txt"
...
alias basv="${VISUAL} ${BASH_UTILS_LOCATION}"
