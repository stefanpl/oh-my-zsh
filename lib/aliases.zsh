...
alias doce="atc > /dev/null 2>&1 && echo \"✅aliases copied\" ; docker_execute_interactive"
...
alias cbu="git clone https://gitlab.com/nwon-group/nwon-tooling/nwon-shell-toolbox.git"
...
alias atc="cat ${CODING_DIR}/snippets/src/bash-aliases.sh ya"
